            ...
            <div class="card p-4 shadow">
                ...
                <form action="{{ route('employees.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="passnum" name="passnum" type="text" value="{{ old('passnum') }}" class="form-control" placeholder="Passport Number" required>
                        @error('passnum')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="idate" name="idate" type="date" value="{{ old('idate') }}" class="form-control" required>
                        @error('idate')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="edate" name="edate" type="date" value="{{ old('edate') }}" class="form-control" required>
                        @error('edate')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
